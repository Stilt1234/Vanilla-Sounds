...
def extract_sounds_json_file():
    try:
        ...
        os.mkdir(os.path.join(os.getcwd(), "Vanilla Sounds", "assets", "for_resourcepack_creators_sounds.json"))
        ...
        shutil.rmtree(os.path.join(os.getcwd(), "Vanilla Sounds", "assets", "for_resourcepack_creators_sounds.json"))